            ...
            <article class="post">
               ...
               <div class="entry-header cf">
                  ...
                  <p class="post-meta">
                     ...
                     <a href="#">By {{$response['user']['name']}}</a> /
               ...
               <div class="post-content">
                  ...
                  <p>{{$row['intro']}}</p>
                  <a href="/Blog{{$row['id']}}" style="float: right;"><i class="fa fa-edit"></i>Edit</a><br>
                        <a href="/DeleteBlog{{$row['id']}}" style="float: right;"><i class="fa fa-trash"></i>Delete</a>
