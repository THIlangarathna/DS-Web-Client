   ...
   <div id="page-title">
    ...
    <section class="s-content s-content--narrow">
        ...
        <div class="row">               
                ...
                <form name="cForm" id="cForm" method="post" action="CreateBlog" enctype="multipart/form-data">
                    <fieldset>

                        <div class="form-field">
                            <input name="title" type="text" id="title" class="full-width" placeholder="Title" value="" required>
                        </div>

                        <div class="form-field">
                            <input name="intro" type="text" id="title" class="full-width" placeholder="Blog Description" value="" required>
                        </div>
                        ...
                        <button type="submit" class="submit btn btn--primary full-width">Create Blog</button>
