            ...
            <nav id="nav-wrap">
               ...
               <ul id="nav" class="nav">
	               ...
	               <li><span><a href="blog.html">Blog</a></span>
                     <ul>
                        <li><a href="blog.html">View Blogs</a></li>
                  ...
                  <li><span><a href="portfolio-index.html">Categories</a></span>
                  <ul>
   ...
   <div id="page-title">
      ...
      <div class="row">
         ...
         <div class="ten columns centered text-center">
            ...
            <p>“With AnswerBug, share your ideas and direct your questions! All the informative blogs and Q&As under different categories.”</p>
         </div>
   ...
   <div class="content-outer">
      ...
      <div id="page-content" class="row portfolio">
         ...
         <section class="entry cf">
            ...
            <div id="primary" class="twelve columns portfolio-list">
                     ...
                     <div class="item-wrap">
                           ...
                           <div class="link-icon"><i class="fa fa-link"></i></div>
          					...
          					<div class="portfolio-item-meta">
          					   <h5><a href="portfolio.html">Technology</a></h5>
          					</div>
                     </div>
          			</div>
