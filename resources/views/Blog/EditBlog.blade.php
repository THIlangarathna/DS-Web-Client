   ...
   <div id="page-title">
    ...
    <section class="s-content s-content--narrow">
        ...
        <div class="row">
                ...
                <form name="cForm" id="cForm" method="POST" action="UpdateBlog" enctype="multipart/form-data">
                    <fieldset>
                        <input type="hidden" name="id" value="{{$response['blog']['id']}}">
                        <div class="form-field">
                            <input name="title" type="text" id="title" class="full-width" placeholder="Title" value="{{$response['blog']['title']}}" required>
                        </div>

                        <div class="form-field">
                            <input name="intro" type="text" id="title" class="full-width" placeholder="Blog Description" value="{{$response['blog']['intro']}}" required>
                        </div>

                        <div class="form-field">
                            <div class="form-group">
                                <label for="exampleFormControlFile1">Change Blog Image</label>
                                <input type="file" class="form-control-file" id="img" name="img" value="http://104.198.5.191/storage/{{$response['blog']['img']}}">
                              </div>
                        </div>
                        
                        <div class="message form-field">
                        <textarea name="content" id="content" class="form-control ckeditor" value="">{{$response['blog']['content']}}</textarea>
                        ...
                        <button type="submit" class="submit btn btn--primary full-width">Edit Blog</button>
